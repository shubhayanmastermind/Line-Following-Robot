...
//track will be white path in black surface
#define left1 10
#define left2 11
#define right2 5
#define right1 6
...
void setup() {
  ...
  pinMode(left1,OUTPUT);//left motor1 input1
  pinMode(left2,OUTPUT);//left motor1 input2
  pinMode(right2,OUTPUT);//right motor2 input1
  pinMode(right1,OUTPUT);//right motor2 input1
